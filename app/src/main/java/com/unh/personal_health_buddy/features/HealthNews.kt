 ...
 * The API key and basic integration were set up using help from ChatGPT / Gemini
 * and the official NewsAPI documentation: https://newsapi.org/docs
 */
...
suspend fun fetchHealthNews(): List<NewsArticle> {
        return withContext(Dispatchers.IO) {
                try {
                        ...
                        connection.setRequestProperty("User-Agent", "Mozilla/5.0") // helps avoid being blocked
                                ...
                                for (i in 0 until articlesArray.length()) {
                                        ...
                                        articles.add(
                                                NewsArticle(
                                                        ...
                                                        urlToImage =
                                                                if (articleJson.has("urlToImage") && !articleJson.isNull("urlToImage"))
